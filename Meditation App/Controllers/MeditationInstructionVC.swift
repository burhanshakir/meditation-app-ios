...
class MeditationInstructionVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Increasing size of scrollview based on size of text view
        scrollView.contentLayoutGuide.bottomAnchor.constraint(equalTo: meditationInstructions.bottomAnchor).isActive = true
